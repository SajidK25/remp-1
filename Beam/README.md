...
```shell
curl -X POST \
  http://beam.subscription.agora.md/api/articles/upsert \
...
$response = file_get_contents("http://beam.subscription.agora.md/api/articles/upsert ", false, $context);
...
```shell
curl -X POST \
  http://beam.subscription.agora.md/api/v2/articles/upsert \
  -H 'Accept: application/json' \
  -H 'Authorization: Bearer XXX' \
  -H 'Content-Type: application/json' \
  -d '{
...
$response = file_get_contents("http://beam.subscription.agora.md/api/v2/articles/upsert ", false, $context);
// process response (raw JSON string)
```
...
```shell
curl -X POST \
  http://beam.subscription.agora.md/api/articles/read \
  -H 'Accept: application/json' \
  -H 'Authorization: Bearer XXX' \
  -H 'Content-Type: application/json' \
  -d '{
...
$response = file_get_contents("http://beam.subscription.agora.md/api/articles/read ", false, $context);
// process response (raw JSON string)
```
...
```shell
curl -X POST \
  http://beam.subscription.agora.md/api/conversions/upsert \
  -H 'Accept: application/json' \
  -H 'Authorization: Bearer XXX' \
  -H 'Content-Type: application/json' \
  -d '{
...
$response = file_get_contents("http://beam.subscription.agora.md/api/conversions/upsert ", false, $context);
// process response (raw JSON string)
```
...
```shell
curl --location --request POST 'http://beam.subscription.agora.md/api/articles/top' \
...
$response = file_get_contents("http://beam.subscription.agora.md/api/articles/top", false, $context);
// process response (raw JSON string)
```
...
```shell
curl --location --request POST 'http://beam.subscription.agora.md/api/v2/articles/top' \
--header 'Content-Type: application/json' \
--header 'Accept: application/json' \
--header 'Authorization: Bearer XXX' \
--data-raw '{
...
$response = file_get_contents("http://beam.subscription.agora.md/api/v2/articles/top", false, $context);
// process response (raw JSON string)
```
...
```shell
curl --location --request POST 'http://beam.subscription.agora.md/api/authors/top' \
--header 'Content-Type: application/json' \
--header 'Accept: application/json' \
--header 'Authorization: Bearer XXX' \
--data-raw '{
...
$response = file_get_contents("http://beam.subscription.agora.md/api/authors/top", false, $context);
// process response (raw JSON string)
```
...
```shell
curl --location --request POST 'http://beam.subscription.agora.md/api/v2/authors/top' \
--header 'Content-Type: application/json' \
--header 'Accept: application/json' \
--header 'Authorization: Bearer XXX' \
--data-raw '{
...
$response = file_get_contents("http://beam.subscription.agora.md/api/v2/authors/top", false, $context);
// process response (raw JSON string)
```
...
```shell
curl --location --request POST 'http://beam.subscription.agora.md/api/tags/top' \
--header 'Content-Type: application/json' \
--header 'Accept: application/json' \
--header 'Authorization: Bearer XXX' \
--data-raw '{
...
$response = file_get_contents("http://beam.subscription.agora.md/api/tags/top", false, $context);
// process response (raw JSON string)
```
...
```shell
curl --location --request POST 'http://beam.subscription.agora.md/api/v2/tags/top' \
--header 'Content-Type: application/json' \
--header 'Accept: application/json' \
--header 'Authorization: Bearer XXX' \
--data-raw '{
...
$response = file_get_contents("http://beam.subscription.agora.md/api/v2/tags/top", false, $context);
// process response (raw JSON string)
```
...
```shell
curl --location --request POST 'http://beam.subscription.agora.md/api/pageviews/histogram' \
--header 'Content-Type: application/json' \
--header 'Accept: application/json' \
--header 'Authorization: Bearer XXX' \
--data-raw '{
...
$response = file_get_contents("http://beam.subscription.agora.md/api/pageviews/histogram", false, $context);
// process response (raw JSON string)
```
...
```shell
curl -X GET \
  http://beam.subscription.agora.md/api/articles?external_ids=123,231 \
  -H 'Accept: application/json' \
  -H 'Authorization: Bearer XXX' \
```
...
$response = file_get_contents("http://beam.subscription.agora.md/api/articles?external_ids=123,231", false, $context);
// process response (raw JSON string)
```
...
```shell
curl -X GET \
  http://beam.subscription.agora.md/api/authors \
  -H 'Accept: application/json' \
  -H 'Authorization: Bearer XXX' \
```
...
$response = file_get_contents("http://beam.subscription.agora.md/api/authors", false, $context);
// process response (raw JSON string)
```
...
```shell
curl -X GET \
  http://beam.subscription.agora.md/api/conversions?conversion_from=2018-06-05T06:03:05Z \
  -H 'Accept: application/json' \
  -H 'Authorization: Bearer XXX' \
```
...
$response = file_get_contents("http://beam.subscription.agora.md/api/conversions?conversion_from=2018-06-05T06:03:05Z", false, $context);
// process response (raw JSON string)
```
...
```shell
curl -X GET \
  http://beam.subscription.agora.md/api/sections \
  -H 'Accept: application/json' \
  -H 'Authorization: Bearer XXX' \
```
...
$response = file_get_contents("http://beam.subscription.agora.md/api/sections", false, $context);
// process response (raw JSON string)
```
...
```shell
curl -X GET \
  http://beam.subscription.agora.md/api/tags \
  -H 'Accept: application/json' \
  -H 'Authorization: Bearer XXX' \
```
...
$response = file_get_contents("http://beam.subscription.agora.md/api/tags", false, $context);
// process response (raw JSON string)
```
...
_Example of uBlock Origin / AdBlockPlus syntax filter_ if your BEAM domain is `beam.subscription.agora.md`:
