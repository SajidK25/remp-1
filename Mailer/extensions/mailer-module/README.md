...
You can select the default mailer on the settings page: http://mailer.subscription.agora.md/settings/
...
screen available at http://mailer.subscription.agora.md/sign/in.
...
Route `http://mailer.subscription.agora.md/health` provides health check for database, Redis, storage and logging.
...
All examples use `http://mailer.subscription.agora.md` as a base domain. Please change the host to the one you use
...
```shell
curl -X POST \
  http://mailer.subscription.agora.md/api/v1/users/user-registered \
...
```shell
curl -X POST \
  http://mailer.subscription.agora.md/api/v1/users/bulk-user-registered \
  -H 'Authorization: Bearer XXX' \
...
```shell
curl -X POST \
  http://mailer.subscription.agora.md/api/v1/users/is-unsubscribed \
  -H 'Authorization: Bearer XXX' \
  -H 'Content-Type: application/json' \
  -d '{
	"user_id": 123,
...
```shell
curl -X POST \
  http://mailer.subscription.agora.md/api/v1/users/is-subscribed \
  -H 'Authorization: Bearer XXX' \
  -H 'Content-Type: application/json' \
  -d '{
	"user_id": 123,
...
```shell
curl -X POST \
  http://mailer.subscription.agora.md/api/v1/users/user-preferences \
  -H 'Authorization: Bearer XXX' \
  -H 'Content-Type: application/json' \
  -d '{
	"user_id": 123,
...
```shell
curl -X POST \
  http://mailer.subscription.agora.md/api/v1/users/subscribe \
  -H 'Authorization: Bearer XXX' \
  -H 'Content-Type: application/json' \
  -d '{
	"email": "admin@example.com",
...
```shell
curl -X POST \
  http://mailer.subscription.agora.md/api/v1/users/un-subscribe \
  -H 'Authorization: Bearer XXX' \
  -H 'Content-Type: application/json' \
  -d '{
	"email": "admin@example.com",
...
```shell
curl -X POST \
  http://mailer.subscription.agora.md/api/v1/users/bulk-subscribe \
  -H 'Authorization: Bearer XXX' \
  -H 'Content-Type: application/json' \
  -d '{
        "users": [
...
```shell
curl -X POST \
  http://mailer.subscription.agora.md/api/v1/users/check-token \
  -H 'Content-Type: application/json' \
  -d '{
...
```shell
curl -X POST \
  http://mailer.subscription.agora.md/api/v1/users/email-changed \
  -H 'Authorization: Bearer XXX' \
  -H 'Content-Type: application/x-www-form-urlencoded' \
...
```shell
curl -X POST \
  http://mailer.subscription.agora.md/api/v1/users/logs-count-per-status \
  -H 'Authorization: Bearer XXX' \
  -H 'Content-Type: application/json' \
  -d '{
    "email": "test@test.com", // String; email
...
```shell
curl -X POST \
  http://mailer.subscription.agora.md/api/v1/users/logs \
  -H 'Authorization: Bearer XXX' \
  -H 'Content-Type: application/json' \
  -d '{
    "filter": {
...
```shell
curl -X POST \
  http://mailer.subscription.agora.md/api/v1/users/delete \
  -H 'Authorization: Bearer XXX' \
  -H 'Content-Type: application/json' \
  -d '{
...
```shell
curl -X GET \
  http://mailer.subscription.agora.md/api/v1/mailers/mail-types?public_listing=1&code=demo-weekly-newsletter \
  -H 'Authorization: Bearer XXX'
```
...
```shell
curl -X GET \
  http://mailer.subscription.agora.md/api/v1/mailers/mail-type-categories \
  -H 'Authorization: Bearer XXX'
```
...
```shell
curl -X POST \
  http://mailer.subscription.agora.md/api/v1/mailers/mail-type-upsert \
  -H 'Authorization: Bearer XXX' \
  -H 'Content-Type: application/json' \
...
```shell
curl -X GET \
  http://mailer.subscription.agora.md/api/v1/mailers/mail-templates \
  -H 'Authorization: Bearer XXX'
```
...
'mailer.subscription.agora.md/api/v1/mailers/templates?mail_type_codes[]=onboarding&mail_type_codes[]=system&with_mail_types=true&page=1&limit=5' \
...
```shell
curl -X POST \
  http://mailer.subscription.agora.md/api/v1/mailers/templates \
  -H 'Authorization: Bearer XXX' \
  -H 'Content-Type: application/x-www-form-urlencoded' \
...
```shell
curl -X GET \
  http://mailer.subscription.agora.md/api/v1/mailers/generator-templates \
  -H 'Authorization: Bearer XXX' \
  -H 'Content-Type: application/x-www-form-urlencoded'
```
...
```shell
curl -X POST \
  http://mailer.subscription.agora.md/api/v1/mailers/generate-mail \
  -H 'Authorization: Bearer XXX' \
  -H 'Content-Type: application/x-www-form-urlencoded' \
...
```shell
curl --location --request GET \
'mailer.subscription.agora.md/api/v1/mailers/render-template?code=demo-email' \
--header 'Content-Type: application/x-www-form-urlencoded' \
--header 'Accept: application/json' \
--header 'Authorization: Bearer XXX'
```
...
```shell
curl -X GET \
  http://mailer.subscription.agora.md/api/v1/segments/list \
  -H 'Authorization: Bearer XXX'
```
...
```shell
curl -X POST \
  http://mailer.subscription.agora.md/api/v1/mailers/jobs \
  -H 'Authorization: Bearer XXX' \
  -H 'Content-Type: application/x-www-form-urlencoded' \
...
```shell
curl -X POST \
  http://mailer.subscription.agora.md/api/v1/mailers/preprocess-generator-parameters \
  -H 'Authorization: Bearer XXX' \
  -H 'Content-Type: application/json' \
  -d '{
...
```json5
{
    ...
    "generator_post_url": "http://mailer.subscription.agora.md/mail-generator/"
}
```
...
```shell
curl -X POST \
  http://mailer.subscription.agora.md/api/v1/mailers/mailgun \
  -H 'Authorization: Bearer XXX' \
  -H 'Content-Type: application/x-www-form-urlencoded' \
...
```shell
curl -X POST \
  http://mailer.subscription.agora.md/api/v2/mailers/mailgun \
  -H 'Authorization: Bearer XXX' \
  -H 'Content-Type: application/json' \
  -d '{
  "signature": {
...
```shell
curl -X POST \
  http://mailer.subscription.agora.md/api/v1/mailers/send-email \
  -H 'Authorization: Bearer XXX' \
  -H 'Content-Type: application/json' \
  -d '{
	"mail_template_code": "welcome_email_with_password",
...
```shell
curl -X POST \
  http://mailer.subscription.agora.md/api/v1/mailers/mail-type-variants \
  -H 'Authorization: Bearer XXX' \
  -H 'Content-Type: application/json' \
  -d '{
	"mail_type_code": "type-25",
