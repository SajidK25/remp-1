...
- Added public preview for emails (templates), accessible without authentication. Preview link is accessible in each email detail eg.: _(http://mailer.t99ltd.info/template/show/1)_.  remp/remp#581
...
- Added health check _(http://beam.t99ltd.info/health)_ for database, Redis, storage and logging. remp/remp#735
...
- Added health check _(http://campaign.t99ltd.info/health)_ for database, Redis, storage and logging. remp/remp#735
...
- Added health check _(http://mailer.t99ltd.info/health)_ for database, Redis, storage and logging. remp/remp#735
...
- Updated major portion of dependencies. Laravel was not updated yet.
- Added health check _(http://sso.t99ltd.info/health)_ for database, Redis, storage and logging. remp/remp#735
...
- Fixing error screen in case SSO wasn't able to log user in https://github.com/remp2020/remp/commit/7fd415459f012c29c991ae763d74c1f0a49fe2cd
  ...
  ```
  SSO_ERROR_URL=http://mailer.t99ltd.info/sign/error
  ```
